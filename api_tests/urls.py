...
from .views import save_test_case_content, parse_and_test, test_api_view, execute_tests, execute_test_case, generate_test_case_content, save_test_result, list_test_executions, test_execution_detail, test_case_detail_api, test_result_detail
...
urlpatterns = [
    ...
    path('test_execution/<int:execution_id>/', test_execution_detail, name='test_execution_detail'),
