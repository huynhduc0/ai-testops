...
from .views import parse_and_test, test_api_view, execute_tests, execute_test_case, generate_test_case_content, save_test_result
...
urlpatterns = [
    ...
    path('save/<int:test_case_id>/', save_test_result, name='save_test_result'),
]